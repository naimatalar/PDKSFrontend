...
const  BanaAtananDataTable = () => {
  ...
  const columns = useMemo(
    ...
    //          <button style={{width: "4rem", backgroundColor:"green", color:"white", height:"2rem", marginRight:"10px",border: "none", borderRadius:"5px", fontWeight:"700"}} onClick={() => addnewgorev(row.original)}>Ekle</button>
    //         <button style={{width: "4rem", backgroundColor:"orange", color:"white", height:"2rem", marginRight:"10px",border: "none", borderRadius:"5px", fontWeight:"700"}} onClick={() => editData(row.original)}>Düzenle</button>
    //         <button style={{width: "4rem", backgroundColor:"red", color:"white", height:"2rem", marginRight:"10px",border: "none", borderRadius:"5px", fontWeight:"700"}} onClick={() => deleteData(row.original)}>Sil</button>
    //       </div>
    //     ),
    //     size: 300,
    //   },
...
export default BanaAtananDataTable;
