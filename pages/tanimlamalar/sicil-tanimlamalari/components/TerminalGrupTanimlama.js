    ...
    return (
        <>
            ...
            <Modal isOpen={modalOpen} toggle={toggle} size="md">
                <AppModalHeader toggle={toggle}>{formInitial.id ? 'Terminal Grubu Düzenle' : 'Terminal Grubu Ekle'}</AppModalHeader>
                <ModalBody>
            ...
            <div className="card">
                <DataTable Refresh={refreshDatatable} DataUrl="TerminalGroup/GetAll" Pagination={{ PageNumber: 0, pageSize: 20 }} UseGetPagination
