    ...
    return (
        <>
            ...
            <Modal isOpen={modalOpen} toggle={toggle} size="md">
                <AppModalHeader toggle={toggle}>{formInitial.id ? 'Direktörlük Düzenle' : 'Direktörlük Ekle'}</AppModalHeader>
                <ModalBody>
            ...
            <div className="card">
                <DataTable Refresh={refreshDatatable} DataUrl="CboDirektorluk/GetAll" Pagination={{ PageNumber: 0, pageSize: 20 }} UseGetPagination
